...
export const GOOGLE_OAUTH_REDIRECT_URI = "http://localhost" as const;
...
// Longer than the callable timeout so a live invocation cannot lose its lease.
export const REGISTRATION_LEASE_MS = 10 * 60 * 1_000;
